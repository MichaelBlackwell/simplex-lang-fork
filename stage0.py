...
class CodeGen:
    ...
    def generate(self, items):
        ...
        self.emit('declare i64 @hashmap_is_empty(i64)')
        self.emit('; HashSet<T> type')
        self.emit('declare i64 @hashset_new()')
        self.emit('declare void @hashset_insert(i64, i64)')
        self.emit('declare i64 @hashset_contains(i64, i64)')
        self.emit('declare i64 @hashset_remove(i64, i64)')
        self.emit('declare i64 @hashset_len(i64)')
        self.emit('declare i64 @hashset_is_empty(i64)')
        self.emit('declare void @hashset_clear(i64)')
        self.emit('declare i64 @hashset_to_vec(i64)')
        ...
        self.emit('declare i64 @hashset_is_subset(i64, i64)')
        self.emit('declare void @hashset_free(i64)')
        self.emit('; Integer-keyed HashMap')
        self.emit('declare i64 @int_hashmap_new()')
        self.emit('declare i64 @int_hashmap_insert(i64, i64, i64)')
        self.emit('declare i64 @int_hashmap_get(i64, i64)')
        self.emit('declare i64 @int_hashmap_contains(i64, i64)')
        self.emit('declare i64 @int_hashmap_remove(i64, i64)')
        self.emit('declare i64 @int_hashmap_len(i64)')
        self.emit('declare i64 @int_hashmap_is_empty(i64)')
        self.emit('declare void @int_hashmap_clear(i64)')
        self.emit('declare void @int_hashmap_free(i64)')
        self.emit('declare i64 @int_hashset_new()')
        self.emit('declare void @int_hashset_insert(i64, i64)')
        self.emit('declare i64 @int_hashset_contains(i64, i64)')
        self.emit('declare i64 @int_hashset_remove(i64, i64)')
        ...
        self.emit('; Vec helper functions')
        self.emit('declare i64 @vec_clone(i64)')
        self.emit('declare i64 @vec_find(i64, i64)')
        self.emit('declare i64 @vec_contains(i64, i64)')
        self.emit('declare i64 @vec_first(i64)')
        self.emit('declare i64 @vec_last(i64)')
        self.emit('declare i64 @vec_reverse(i64)')
        self.emit('declare i64 @vec_sum(i64)')
        self.emit('; String helper functions')
        self.emit('declare i64 @string_join(i64, i64)')
        self.emit('declare i64 @string_len(i64)')
        self.emit('declare i64 @string_concat(i64, i64)')
        self.emit('declare i64 @string_eq(i64, i64)')
        self.emit('declare i64 @string_contains(i64, i64)')
        self.emit('declare i64 @string_starts_with(i64, i64)')
        self.emit('declare i64 @string_ends_with(i64, i64)')
        self.emit('declare i64 @string_substring(i64, i64, i64)')
        self.emit('declare i64 @string_char_at(i64, i64)')
        self.emit('declare i64 @string_find(i64, i64)')
        self.emit('declare i64 @string_split(i64, i64)')
        self.emit('declare i64 @string_replace(i64, i64, i64)')
        self.emit('declare i64 @string_trim(i64)')
        self.emit('declare i64 @string_to_uppercase(i64)')
        self.emit('declare i64 @string_to_lowercase(i64)')
        self.emit('declare i64 @int_to_string(i64)')
        self.emit('declare i64 @string_to_int(i64)')
        self.emit('; Vec wrapper functions')
        self.emit('declare i64 @vec_new()')
        self.emit('declare void @vec_push(i64, i64)')
        self.emit('declare i64 @vec_len(i64)')
        self.emit('declare i64 @vec_get(i64, i64)')
        self.emit('declare void @vec_set(i64, i64, i64)')
        self.emit('declare i64 @vec_pop(i64)')
        self.emit('; Result helper')
        self.emit('declare i64 @result_ok_or(i64, i64)')
        self.emit('; Iterator functions')
        self.emit('declare i64 @sxiter_from_vec(i64)')
        self.emit('declare i64 @sxiter_range(i64, i64)')
        self.emit('declare i64 @sxiter_range_step(i64, i64, i64)')
        self.emit('declare i64 @sxiter_next(i64)')
        self.emit('declare i64 @sxiter_collect(i64)')
        self.emit('declare i64 @sxiter_count(i64)')
        self.emit('declare i64 @sxiter_sum(i64)')
        self.emit('declare i64 @sxiter_product(i64)')
        self.emit('declare i64 @sxiter_min(i64)')
        self.emit('declare i64 @sxiter_max(i64)')
        self.emit('declare i64 @sxiter_any(i64, i64)')
        self.emit('declare i64 @sxiter_all(i64, i64)')
        self.emit('declare i64 @sxiter_find(i64, i64)')
        self.emit('declare i64 @sxiter_position(i64, i64)')
        self.emit('declare i64 @sxiter_nth(i64, i64)')
        self.emit('declare i64 @sxiter_last(i64)')
        self.emit('declare void @sxiter_free(i64)')
        self.emit('declare i64 @sxiter_chain(i64, i64)')
        self.emit('declare i64 @sxiter_collect_vec(i64)')
        self.emit('declare i64 @sxiter_enumerate(i64)')
        self.emit('declare i64 @sxiter_filter(i64, i64)')
        self.emit('declare i64 @sxiter_fold(i64, i64, i64)')
        self.emit('declare i64 @sxiter_map(i64, i64)')
        self.emit('declare i64 @sxiter_skip(i64, i64)')
        self.emit('declare i64 @sxiter_take(i64, i64)')
